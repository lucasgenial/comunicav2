...
$('.clicador').on("click", function(e){
	...
	if(!$("#"+$(this).attr('data-identificador')).is(':checked')){
		...
		$('#servidoresSelects').append('<input type=text value='+$(this).attr('data-identificador')+' class="marcados servi-'+$(this).attr('data-identificador')+'" />');
		}else{
...
//	window.location.href= "/admin/cadastros/gestaoefetivo/adicionaServidorNaMesaNova/"+servidoresSelecionados;
	window.location.replace("/admin/cadastros/gestaoefetivo/adicionaServidorNaMesaNova/"+servidoresSelecionados);
});
