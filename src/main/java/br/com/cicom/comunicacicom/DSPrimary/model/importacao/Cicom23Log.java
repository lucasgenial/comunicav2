...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom23log")
@SuppressWarnings("serial")
public class Cicom23Log extends CecocoLog implements Serializable{
	...
	public Cicom23Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Cicom23Log other = (Cicom23Log) obj;
		if (anotacao == null) {
