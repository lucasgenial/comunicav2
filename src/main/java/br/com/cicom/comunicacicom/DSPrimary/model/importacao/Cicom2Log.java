...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom2log")
@SuppressWarnings("serial")
public class Cicom2Log extends CecocoLog implements Serializable{
	...
	public Cicom2Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
