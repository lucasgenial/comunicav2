...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom11")
@SuppressWarnings("serial")
public class Cicom11 extends Cecoco implements Serializable {
	...
	public String toString() {
		return "Cicom 11 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
