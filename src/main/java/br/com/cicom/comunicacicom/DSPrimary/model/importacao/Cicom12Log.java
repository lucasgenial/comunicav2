...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom12log")
@SuppressWarnings("serial")
public class Cicom12Log extends CecocoLog implements Serializable{
	...
	public Cicom12Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Cicom12Log other = (Cicom12Log) obj;
		if (anotacao == null) {
