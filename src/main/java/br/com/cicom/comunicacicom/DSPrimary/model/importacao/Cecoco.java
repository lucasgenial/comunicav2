...
public class Cecoco implements Importacao  {

	public Cecoco() {
		super();
	}
	public Cecoco(Long id, Long estabelecimento, LocalDate datainicio, LocalTime horainicio, String tipo,
			String descricao, String historico, String endereco, String pontoreferencia, String bairro, String distrito,
			String cidade, String latitude, String longitude, Long estado) {
		this.id = id;
