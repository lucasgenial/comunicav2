...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom2")
@SuppressWarnings("serial")
public class Cicom2 extends Cecoco implements Serializable{
	...
	public String toString() {
		return "Cicom02 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
