...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom9log")
@SuppressWarnings("serial")
public class Cicom9Log extends CecocoLog implements Serializable{
	...
	public Cicom9Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
