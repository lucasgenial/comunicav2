...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom10")
@SuppressWarnings("serial")
public class Cicom10 extends Cecoco implements Serializable {
	...
	public String toString() {
		return "Cicom10 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
