...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom7log")
@SuppressWarnings("serial")
public class Cicom7Log extends CecocoLog implements Serializable{
	...
	public Cicom7Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
