...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom3")
@SuppressWarnings("serial")
public class Cicom3 extends Cecoco implements Serializable{
	...
	public String toString() {
		return "Cicom3 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
