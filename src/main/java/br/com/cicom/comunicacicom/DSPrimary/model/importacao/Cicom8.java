...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom8")
@SuppressWarnings("serial")
public class Cicom8 extends Cecoco implements Serializable {
	...
	public String toString() {
		return "Cicom 8 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio="
