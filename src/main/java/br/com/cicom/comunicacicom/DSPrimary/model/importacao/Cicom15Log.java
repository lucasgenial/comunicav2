...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom15log")
@SuppressWarnings("serial")
public class Cicom15Log extends CecocoLog implements Serializable{
	...
	public Cicom15Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Cicom15Log other = (Cicom15Log) obj;
		if (anotacao == null) {
