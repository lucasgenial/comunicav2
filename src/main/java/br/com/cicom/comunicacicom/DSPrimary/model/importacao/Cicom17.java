...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom17")
@SuppressWarnings("serial")
public class Cicom17 extends Cecoco implements Serializable{
	...
	public String toString() {
		return "Cicom17 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
