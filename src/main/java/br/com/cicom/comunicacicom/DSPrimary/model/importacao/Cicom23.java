...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom23")
@SuppressWarnings("serial")
public class Cicom23 extends Cecoco implements Serializable {
	...
	public String toString() {
		return "Cicom23 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
