...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom15")
@SuppressWarnings("serial")
public class Cicom15 extends Cecoco implements Serializable{
	...
	public String toString() {
		return "Cicom 15 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
