...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom18")
@SuppressWarnings("serial")
public class Cicom18 extends Cecoco implements Serializable{
	...
	public String toString() {
		return "Cicom18 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
