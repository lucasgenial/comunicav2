...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom13")
@SuppressWarnings("serial")
public class Cicom13 extends Cecoco implements  Serializable {
	...
	public String toString() {
		return "Cicom 13 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
