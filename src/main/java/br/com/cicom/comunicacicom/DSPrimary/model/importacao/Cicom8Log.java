...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom8log")
@SuppressWarnings("serial")
public class Cicom8Log extends CecocoLog implements Serializable{
	...
	public Cicom8Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
