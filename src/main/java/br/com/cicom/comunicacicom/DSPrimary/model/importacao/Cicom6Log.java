...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom06log")
@SuppressWarnings("serial")
public class Cicom6Log extends CecocoLog implements Serializable{
	...
	public Cicom6Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
