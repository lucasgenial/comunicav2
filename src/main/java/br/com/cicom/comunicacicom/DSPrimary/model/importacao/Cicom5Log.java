...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom5log")
@SuppressWarnings("serial")
public class Cicom5Log extends CecocoLog implements Serializable{
	...
	public Cicom5Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
