...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom1log")
@SuppressWarnings("serial")
public class Cicom1Log extends CecocoLog implements Serializable{
	...
	public Cicom1Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
