...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom14log")
@SuppressWarnings("serial")
public class Cicom14Log extends CecocoLog implements Serializable{
	...
	public Cicom14Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Cicom14Log other = (Cicom14Log) obj;
		if (anotacao == null) {
