...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom19")
@SuppressWarnings("serial")
public class Cicom19 extends Cecoco implements Serializable {
	...
	public String toString() {
		return "Cicom 19 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
