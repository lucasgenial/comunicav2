...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom22log")
@SuppressWarnings("serial")
public class Cicom22Log extends CecocoLog implements Serializable{
	...
	public Cicom22Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Cicom22Log other = (Cicom22Log) obj;
		if (anotacao == null) {
