...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom4")
@SuppressWarnings("serial")
public class Cicom4 extends Cecoco implements Serializable {
	...
	public String toString() {
		return "Cicom4 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio="
