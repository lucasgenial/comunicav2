...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom17log")
@SuppressWarnings("serial")
public class Cicom17Log extends CecocoLog implements Serializable{
	...
	public Cicom17Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Cicom17Log other = (Cicom17Log) obj;
		if (anotacao == null) {
