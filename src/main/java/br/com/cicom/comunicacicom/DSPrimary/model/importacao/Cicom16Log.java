...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom16log")
@SuppressWarnings("serial")
public class Cicom16Log extends CecocoLog implements Serializable{
	...
	public Cicom16Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Cicom16Log other = (Cicom16Log) obj;
		if (anotacao == null) {
