...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom7")
@SuppressWarnings("serial")
public class Cicom7 extends Cecoco implements Serializable {
	...
	public String toString() {
		return "Cicom07 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio="
