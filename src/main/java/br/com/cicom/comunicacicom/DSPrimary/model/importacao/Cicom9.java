...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom9")
@SuppressWarnings("serial")
public class Cicom9 extends Cecoco implements Serializable{
	...
	public String toString() {
		return "Cicom 9 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
