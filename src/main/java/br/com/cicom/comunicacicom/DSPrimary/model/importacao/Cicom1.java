...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom1")
@SuppressWarnings("serial")
public class Cicom1 extends Cecoco implements Serializable {
	...
	public String toString() {
		return "Cicom1 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
