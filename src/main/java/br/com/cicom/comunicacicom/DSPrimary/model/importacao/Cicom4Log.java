...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom4log")
@SuppressWarnings("serial")
public class Cicom4Log extends CecocoLog implements Serializable{
	...
	public Cicom4Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
