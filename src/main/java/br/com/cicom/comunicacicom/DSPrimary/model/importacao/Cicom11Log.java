...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom11log")
@SuppressWarnings("serial")
public class Cicom11Log extends CecocoLog implements Serializable{
	...
	public Cicom11Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Cicom11Log other = (Cicom11Log) obj;
		if (anotacao == null) {
