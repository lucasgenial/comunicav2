...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom14")
@SuppressWarnings("serial")
public class Cicom14 extends Cecoco implements Serializable {
	...
	public String toString() {
		return "Cicom14 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
