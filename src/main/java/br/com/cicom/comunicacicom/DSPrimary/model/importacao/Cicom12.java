...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom12")
@SuppressWarnings("serial")
public class Cicom12 extends Cecoco implements Serializable{
	...
	public String toString() {
		return "Cicom12 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
