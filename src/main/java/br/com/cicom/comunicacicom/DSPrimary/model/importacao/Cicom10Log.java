...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom10log")
@SuppressWarnings("serial")
public class Cicom10Log extends CecocoLog implements Serializable{
	...
	public Cicom10Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Cicom10Log other = (Cicom10Log) obj;
		if (anotacao == null) {
