...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom3log")
@SuppressWarnings("serial")
public class Cicom3Log extends CecocoLog implements Serializable{
	...
	public Cicom3Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
