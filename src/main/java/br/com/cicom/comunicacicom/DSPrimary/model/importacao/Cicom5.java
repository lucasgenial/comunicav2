...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom5")
@SuppressWarnings("serial")
public class Cicom5 extends Cecoco implements Serializable {
	...
	public String toString() {
		return "Cicom 5 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
