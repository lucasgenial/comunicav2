...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom20")
@SuppressWarnings("serial")
public class Cicom20 extends Cecoco implements Serializable {
	...
	public String toString() {
		return "Cicom 20 [id=" + id + ", tipo=" + tipo + ", estabelecimento=" + estabelecimento + ", datainicio=" + datainicio
				+ ", horainicio=" + horainicio + ", tipo=" + tipo + ", endereco=" + endereco + ", pontoreferencia=" + pontoreferencia + ", bairro=" + bairro
				+ ", distrito=" + distrito + ", cidade=" + cidade + ", latitude=" + latitude + ", longitude="
				+ longitude + ", estado=" + estado + ", descricao=" + descricao + "]";
	}

	public String limpaFrase(String frase) {
