...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom19log")
@SuppressWarnings("serial")
public class Cicom19Log extends CecocoLog implements Serializable{
	...
	public Cicom19Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Cicom19Log other = (Cicom19Log) obj;
		if (anotacao == null) {
