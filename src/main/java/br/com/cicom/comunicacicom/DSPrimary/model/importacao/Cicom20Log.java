...
@Entity
@Immutable
@Subselect("SELECT * FROM cicom20log")
@SuppressWarnings("serial")
public class Cicom20Log extends CecocoLog implements Serializable{
	...
	public Cicom20Log(Long id, Long ocorrencia, Long estabelecimento, LocalDateTime data, String descricao,
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Cicom20Log other = (Cicom20Log) obj;
		if (anotacao == null) {
