...
public class DownloadController {
	...
	public String getListFiles(Model model) {
		model.addAttribute("files", serviceArquivo.buscarPorServidor(serviceServidor.buscaPorId(servicoUsuario
				.buscaPeloLogin(SecurityContextHolder.getContext().getAuthentication().getName()).getServidor().getId())
				.get().getId()));
