		...
		"columns": [
				...
				{			
		            ...
		            render: function tipoAcesso(data, type, full, meta){            		            	
		            	return 	trocarNomeTipoAcesso(full.usuario);
		            }
		        },				
				{
		            targets: -1,
...
function visualizarArquivo(_servidor){
	...
	return '<a class="dropdown-item" href="/admin/arquivos/'+ _servidor.id +' "data-titulo="Adcionar Solicitação" id="'+ _servidor.id +'" inline="text" ><i class="far fa-edit"></i> Arquivo</a>'
}
