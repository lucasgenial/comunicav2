				...
				},
				{
		          ...
		          render: function adicionaBotaoAcao(data, type, full, meta){
		            	...
		            	var botaoAcao = '<div class="btn-group" role="group" aria-label="Button group with nested dropdown">'+
						   ...
						   '				<a class="dropdown-item" href="visualizar/'+ full.id +'" id="'+ full.id +'"><i class="glyphicon glyphicon-eyes-open"></i> Visualizar</a>'+
						                     habilitarOuDesabilitar(full.ativo, full.id)+
						   '				<a class="dropdown-item" href="/cidades/editar/'+ full.id +'" data-titulo="Editar Cidade" id="'+ full.id +'" th:inline="text" ><i class="far fa-edit"></i> Editar</a>'+
						   '			</div>'+
						   '		</div>'+
						   '	</div>'
