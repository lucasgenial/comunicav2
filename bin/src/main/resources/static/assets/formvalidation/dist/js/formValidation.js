...
(function (global, factory) {
    ...
    var AutoFocus = function (_Plugin) {
        ...
        function AutoFocus() {
            ...
            var _this = possibleConstructorReturn(this, (AutoFocus.__proto__ || Object.getPrototypeOf(AutoFocus)).call(this, {}));
    ...
    var Framework = function (_Plugin) {
        ...
        createClass(Framework, [{
            ...
            value: function onElementNotValidated(e) {
                ...
                var type = e.element.getAttribute('type');
                var element = 'radio' === type || 'checkbox' === type ? elements[0] : e.element;
                classSet(element, (_classSet7 = {}, defineProperty(_classSet7, this.opts.eleValidClass, false), defineProperty(_classSet7, this.opts.eleInvalidClass, false), _classSet7));
                var groupEle = this.containers.get(element);
                if (groupEle) {
                    var _classSet8;
